...
describe Dessert do
  let(:chef) { double("chef", name: "Flanderson") }
  ...
  describe "#initialize" do
    ...
    it "sets a quantity" do
      expect(brownie.quantity).to eq(500)
    end
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("pie", "kilograms", chef)}.to raise_error(ArgumentError)
    end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["flour", "baking soda", "eggs", "milk"]
      brownie.mix!
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect { brownie.eat(100)}.to raise_error("we ran out!")
    end
  end
